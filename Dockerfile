...
# 添加镜像
ADD Alibaba_Dragonwell_Standard_11.0.18.14.9_x64_linux.tar.gz .
RUN mv dragonwell-11.0.18.14+9-GA/* .

# 设置环境变量
ENV JAVA_HOME=/usr/local/dragonwell-11
ENV JAVA_VERSION=11.0.18.14
ENV DRAGONWELL_VERSION=11.0.18.14-Standard
